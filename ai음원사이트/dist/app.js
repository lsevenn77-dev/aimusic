...
const credits=t=>t.kind==='cover'?`<a href="#producer/${t.producer_id}">${esc(t.producer)}</a> 커버 · 원곡 <a href="#song/${t.original_id}">${esc(t.original_artist)}</a>`:`<a href="#artist/${t.artist_id}">${esc(t.artist)}</a> · <a href="#producer/${t.producer_id}">${esc(t.producer)}</a>`;
